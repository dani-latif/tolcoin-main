    ...
    <div class="card-deck">
        <div class="card mb-3 overflow-hidden" style="min-width: 12rem">
            ...
            <div class="card-body position-relative">
                <h6>Users<span class="badge badge-soft-warning rounded-capsule ml-2">0%</span></h6>
                 <div class="display-4 fs-4 mb-2 font-weight-normal text-sans-serif text-warning" data-countupp='{"count":58386,"format":"alphanumeric"}'>0</div>
                <!--<a class="font-weight-semi-bold fs--1 text-nowrap" href="#!"><span class="fas fa-angle-right ml-1" data-fa-transform="down-1"></span></a> -->
            </div>
        </div>
        <div class="card mb-3 overflow-hidden" style="min-width: 12rem">
            ...
            <div class="card-body position-relative">
                <h6>Total investment<span class="badge badge-soft-info rounded-capsule ml-2">0%</span></h6>
                <div class="display-4 fs-4 mb-2 font-weight-normal text-sans-serif text-info" data-countupp='{"count":23434,"format":"alphanumeric"}'>0</div>
                <!-- <a class="font-weight-semi-bold fs--1 text-nowrap" href="#!">All orders<span class="fas fa-angle-right ml-1" data-fa-transform="down-1"></span></a> -->
            </div>
        </div>
        <div class="card mb-3 overflow-hidden" style="min-width: 12rem">
            ...
            <div class="card-body position-relative">
                <h6>Total rewards<span class="badge badge-soft-success rounded-capsule ml-2">0%</span></h6>
                <div class="display-4 fs-4 mb-2 font-weight-normal text-sans-serif" data-countup='{"count":0,"format":"comma","prefix":"$"}'>0</div>
...
{{--                                <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal mr-3" type="button" id="dropdown0" data-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="fas fa-ellipsis-h fs--1"></span></button>--}}
...
{{--                        <td class="align-middle white-space-nowrap">--}}
{{--                            <div class="dropdown text-sans-serif">--}}
{{--                                <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal mr-3" type="button" id="dropdown2" data-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="fas fa-ellipsis-h fs--1"></span></button>--}}
...
{{--                        <td class="align-middle white-space-nowrap">--}}
{{--                            <div class="dropdown text-sans-serif">--}}
{{--                                <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal mr-3" type="button" id="dropdown4" data-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="fas fa-ellipsis-h fs--1"></span></button>--}}
...
{{--                        <td class="align-middle white-space-nowrap">--}}
{{--                            <div class="dropdown text-sans-serif">--}}
{{--                                <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal mr-3" type="button" id="dropdown5" data-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="fas fa-ellipsis-h fs--1"></span></button>--}}
...
{{--                        <td class="align-middle white-space-nowrap">--}}
{{--                            <div class="dropdown text-sans-serif">--}}
{{--                                <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal mr-3" type="button" id="dropdown6" data-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="fas fa-ellipsis-h fs--1"></span></button>--}}
...
{{--                        <td class="align-middle white-space-nowrap">--}}
{{--                            <div class="dropdown text-sans-serif">--}}
{{--                                <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal mr-3" type="button" id="dropdown7" data-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="fas fa-ellipsis-h fs--1"></span></button>--}}
...
{{--                        <td class="align-middle white-space-nowrap">--}}
{{--                            <div class="dropdown text-sans-serif">--}}
{{--                                <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal mr-3" type="button" id="dropdown8" data-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="fas fa-ellipsis-h fs--1"></span></button>--}}
...
{{--                        <td class="align-middle white-space-nowrap">--}}
{{--                            <div class="dropdown text-sans-serif">--}}
{{--                                <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal mr-3" type="button" id="dropdown9" data-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="fas fa-ellipsis-h fs--1"></span></button>--}}
...
{{--                        <td class="align-middle white-space-nowrap">--}}
{{--                            <div class="dropdown text-sans-serif">--}}
{{--                                <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal mr-3" type="button" id="dropdown10" data-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="fas fa-ellipsis-h fs--1"></span></button>--}}
        ...
        <div class="col-lg-4 pr-lg-2">
            <div class="card h-100 bg-gradient">
                ...
                <div class="card-body text-white fs--1">
                    ...
                    <canvas id="real-time-user" width="10" height="4"></canvas>
...
{{--                    </div>--}}
                ...
                <!-- <a class="text-white" href="#!">Real-time report<span class="fa fa-chevron-right ml-1 fs--1"></span></a> -->
            </div>
            </div>
        </div>
        <div class="col-lg-8 pl-lg-2">
            <div class="card h-100 mt-3 mt-lg-0">
                <div class="card-header bg-light d-flex justify-content-between">
                    ...
                    <div class="dropdown text-sans-serif">
                        <!-- <button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none" type="button" data-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="fas fa-ellipsis-h fs--1"></span></button> -->
